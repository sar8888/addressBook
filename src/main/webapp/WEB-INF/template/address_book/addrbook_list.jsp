<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" errorPage="addrbook_error.jsp" import="java.util.*, address_book.*"%>
<!DOCTYPE HTML>
<html>
<head>
...
<script type="text/javascript">
	function check(ab_id) {
		...
		document.location.href="/address_book/addrbook_control.jsp?action=edit&ab_id="+ab_id+"&upasswd="+pwd;
	}
</script>
...
<HR>
<form>
<a href="/address_book/addForm">주소록 등록</a><P>
