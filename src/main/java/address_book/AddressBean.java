...
public class AddressBean {
	...
	String jdbc_url = "jdbc:mysql://localhost:3306/addressbook";
	...
	public boolean updateDB(AddressBook addrbook) {
		connect();
	...
	// 신규 주소록 메시지 추가 메서드
	public boolean insertDB(AddressBook addrbook) {
		connect();
	...
	// 특정 주소록 게시글 가져오는 메서드
	public AddressBook getDB(int gb_id) {
		connect();
	...
	public ArrayList<AddressBook> getDBList() {
		connect();
		ArrayList<AddressBook> datas = new ArrayList<AddressBook>();
